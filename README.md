...
На данных очищенного датасета для целевой переменной 'Модуль упругости при растяжении, ГПа' обучены модели различных регрессоров (7 шт.), для которых коэффициент детерминации на тестовой выборке составил 𝑅2 = 0,7 – 0,86.
