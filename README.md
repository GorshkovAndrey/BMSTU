...
На данных очищенного датасета для целевой переменной 'Модуль упругости при растяжении, ГПа' обучены модели различных регрессоров, для которых коэффициент детерминации на тестовой выборке составил 𝑅2 = 0,7 – 0,86.

На данных очищенного датасета для целевой переменной 'Прочность при растяжении, МПа' обучены модели различных регрессоров, для которых коэффициент детерминации на тестовой выборке составил 𝑅2 = 0,73 – 0,83.
