...
По данным базового датасета выявлены линейные функциональные зависимости для целевых переменных 'Модуль упругости при растяжении, ГПа' и 'Прочность при растяжении, МПа' от признаков 'Поверхностная плотность' и 'Потребление смолы'.
